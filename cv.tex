...
2011--2013& Master degree : Faculty of management science and informatics, Computer engineering, Ing. (Msc.) \\
	& Diploma thesis : Operational system for arm cortex-m3 \\
...
C++, Ruby & advenced \\
VHLD, Java & basic \\
tools & GNU GCC, G++, Qt, Boost, Gnuplot, Sublime, Atom, OpenMPI, Linux, Latex \\
microcontrollers & ARM Cortex M0..M4 (stm32), MSP430, AVR \\
technologies & NRF70, Xbee, NVIDIA Cuda, Xilinx FPGA \\
...
2013 & Master degree with honours \\
...
programming in embedded C (std 99), simulations in C++ (std 11) or Ruby
\begin{itemize}
...
\begin{itemize}
\item \href{https://github.com/michalnand/sparse\_memory}{current research : https://github.com/michalnand/sparse\_memory}
